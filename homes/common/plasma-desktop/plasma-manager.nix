{
  programs.plasma = {
    ...
    shortcuts = {
      ...
      "services/org.kde.spectacle.desktop"."OpenWithoutScreenshot" = "Meta+Shift+S";
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."1920x1080 screen: Height" = 549;
      "dolphinrc"."ExtractDialog"."1920x1080 screen: Width" = 1268;
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,3,30,22,36,23.852";
      ...
      "kactivitymanagerdrc"."activities"."90924c8a-aa96-4218-8533-1a68a09f1833" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "90924c8a-aa96-4218-8533-1a68a09f1833";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "816,571";
      ...
      "kdeglobals"."General"."font" = "Atkinson Hyperlegible,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."menuFont" = "Atkinson Hyperlegible,10,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."smallestReadableFont" = "Atkinson Hyperlegible,8,-1,5,50,0,0,0,0,0";
      "kdeglobals"."General"."toolBarFont" = "Atkinson Hyperlegible,10,-1,5,50,0,0,0,0,0";
      ...
      "kdeglobals"."WM"."activeFont" = "Atkinson Hyperlegible,10,-1,5,50,0,0,0,0,0";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{9a8aed8a-580d-4661-ba54-f409bd9fe9fa}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{96704973-5dbe-4e3c-8920-b7f1955a57f7}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{4a0689f1-e6a3-401b-9583-e36ca87b4307}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{b097b428-0623-4b47-928d-274d8915eccc}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{0cf0cc70-22ba-484d-b804-7463c4f38ab3}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{a83baedb-74b9-4ad2-a7eb-665c74c888ea}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{bd5c71c0-227c-4ba0-8a09-c61eb77413d2}";
      ...
      "khotkeysrc"."General"."XftAntialiasx5b$dx5d" = "";
      ...
      "khotkeysrc"."General"."accentColorFromWallpaperx5b$dx5d" = "";
      ...
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."Image" = "/nix/store/m5za1canh7c6k0k1bjp4n4dwb299klaq-hm_lotte.png";
      "kscreenlockerrc"."Greeter/Wallpaper/org.kde.image/General"."PreviewImage" = "/nix/store/m5za1canh7c6k0k1bjp4n4dwb299klaq-hm_lotte.png";
      "kscreenlockerrc"."Greeter/Wallpaper/org/kde/image/General"."Image" = "/home/lotte/Pictures/Artprojects/2023-04-08_LKABMinetrain_small.png";
      "kscreenlockerrc"."Greeter/Wallpaper/org/kde/image/General"."PreviewImage" = "/home/lotte/Pictures/Artprojects/2023-04-08_LKABMinetrain_small.png";
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Desktops"."Id_1" = "00986b29-b2a6-4bc9-a32b-172790790f6b";
      ...
      "kwinrc"."NightColor"."LatitudeAuto" = 49.51;
      "kwinrc"."NightColor"."LongitudeAuto" = 8.53;
      "kwinrc"."NightColor"."NightTemperature" = 3200;
      "kwinrc"."Plugins"."diminactiveEnabled" = true;
      "kwinrc"."Plugins"."wobblywindowsEnabled" = true;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/17d429da-7095-58e7-8990-bde21abda336"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/8a79936b-16c5-5fa2-9807-6f8d84b677cf"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrulesrc"."1"."Description" = "Application settings for krita";
      "kwinrulesrc"."1"."clientmachine" = "localhost";
      "kwinrulesrc"."1"."skiptaskbarrule" = 3;
      "kwinrulesrc"."1"."wmclass" = "krita";
      "kwinrulesrc"."1"."wmclassmatch" = 1;
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."Description" = "Window settings for krita";
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."clientmachine" = "localhost";
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."skiptaskbarrule" = 5;
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."title" = "Krita";
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."types" = 1;
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."windowrole" = "MainWindow#1";
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."windowrolematch" = 1;
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."wmclass" = "krita";
      "kwinrulesrc"."2d7d812e-6249-4598-b028-2f67384a7908"."wmclassmatch" = 1;
      "kwinrulesrc"."46e477d9-0f1e-455b-9de1-bcbe25d7dba1"."Description" = "Application settings for krita";
      "kwinrulesrc"."46e477d9-0f1e-455b-9de1-bcbe25d7dba1"."clientmachine" = "localhost";
      "kwinrulesrc"."46e477d9-0f1e-455b-9de1-bcbe25d7dba1"."skiptaskbarrule" = 3;
      "kwinrulesrc"."46e477d9-0f1e-455b-9de1-bcbe25d7dba1"."wmclass" = "krita";
      "kwinrulesrc"."46e477d9-0f1e-455b-9de1-bcbe25d7dba1"."wmclassmatch" = 1;
      ...
      "plasmanotifyrc"."Applications/nheko"."Seen" = true;
    ...
    dataFile = {
      ...
      "kate/anonymous.katesession"."Document 0"."Highlighting" = "JavaScript";
      ...
      "kate/anonymous.katesession"."Document 0"."Mode" = "JavaScript";
      "kate/anonymous.katesession"."Document 0"."Mode Set By User" = false;
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/lotte/Zotero/translators/Europe PMC.js";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-0-Splitter" = 403;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-1-Splitter" = 403;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 343;
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-V-Splitter" = "0,401,0";
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = "file:///home/lotte/Zotero/translators/Europe PMC.js";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "file:///home/lotte/Zotero/translators/Europe PMC.js";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 0" = "file:///home/lotte/Zotero/translators/Europe PMC.js";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/lotte\\/Zotero\\/translators\\/Europe PMC.js"."CursorColumn" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/lotte\\/Zotero\\/translators\\/Europe PMC.js"."CursorLine" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/lotte\\/Zotero\\/translators\\/Europe PMC.js"."Dynamic Word Wrap" = true;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/lotte\\/Zotero\\/translators\\/Europe PMC.js"."JumpList" = "";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/lotte\\/Zotero\\/translators\\/Europe PMC.js"."TextFolding" = "{\"checksum\":\"848dcb9923ac27aae0a9e116462d1695500c63d1\",\"ranges\":[]}";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/lotte\\/Zotero\\/translators\\/Europe PMC.js"."ViMarks" = "";
