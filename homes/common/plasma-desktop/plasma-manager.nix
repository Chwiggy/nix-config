{
  programs.plasma = {
    ...
    configFile = {
      ...
      "dolphinrc"."ExtractDialog"."DirHistory[$e]" = "$HOME/code/gitlab.gistools.geog.uni-heidelberg.de/ewilke/gtfs-playground/";
      ...
      "khotkeysrc"."General"."accentColorFromWallpaper\x5b$d\x5d" = "";
